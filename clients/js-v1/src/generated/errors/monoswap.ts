...
codeToErrorMap.set(0xb, InvalidSystemProgramError);
nameToErrorMap.set('InvalidSystemProgram', InvalidSystemProgramError);

/** IninitalizedMint: IninitalizedMint */
export class IninitalizedMintError extends ProgramError {
  override readonly name: string = 'IninitalizedMint';

  readonly code: number = 0xc; // 12

  constructor(program: Program, cause?: Error) {
    super('IninitalizedMint', program, cause);
  }
}
codeToErrorMap.set(0xc, IninitalizedMintError);
nameToErrorMap.set('IninitalizedMint', IninitalizedMintError);

/** MissingNiftyGroup: Missing Nifty Group account */
export class MissingNiftyGroupError extends ProgramError {
  override readonly name: string = 'MissingNiftyGroup';

  readonly code: number = 0xd; // 13

  constructor(program: Program, cause?: Error) {
    super('Missing Nifty Group account', program, cause);
  }
}
 ...
 * @category Errors
 */
export function getMonoswapErrorFromCode(
  code: number,
  program: Program,
  cause?: Error
): ProgramError | null {
 ...
 * @category Errors
 */
export function getMonoswapErrorFromName(
  name: string,
  program: Program,
  cause?: Error
): ProgramError | null {
