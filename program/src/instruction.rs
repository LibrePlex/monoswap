...
pub enum MonoswapInstruction {
    ...
    #[account(6, optional, writable, name="swap_marker_ata", desc = "ATA account for the swap marker, if applicable")]
    #[account(7, optional, writable, name="authority_ata", desc = "ATA account for the authority, if applicable")]
